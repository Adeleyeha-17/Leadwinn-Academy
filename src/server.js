...
createServer({
    ...
    seeds(server) {
        ...
        server.create("van", { id: "8", students: 25, rating: 4.8,name: "The Ultimate JavaScript Mastery Course for Beginners", price: 60, description: "The Modest Explorer is a van designed to get you out of the house and into nature. This beauty is equipped with solar panels, a composting toilet, a water tank and kitchenette. The idea is that you can pack up your home and escape for a weekend or even longer!", imageUrl: scratch, type: "Technology", instructorUrl: adeleye , tick: checked})
        server.create("van", { id: "9", students: 20, rating: 4.3,name: "Introduction to Artificial Intelligence", price: 80, description: "Beach Bum is a van inspired by surfers and travelers. It was created to be a portable home away from home, but with some cool features in it you won't find in an ordinary camper.", imageUrl: mit, type: "Technology", instructorUrl: adeleye , tick: checked})
        server.create("van", { id: "10", students: 18, rating: 4.5,name: "Advanced Scratch Development", price: 100, description: "Reliable Red is a van that was made for travelling. The inside is comfortable and cozy, with plenty of space to stretch out in. There's a small kitchen, so you can cook if you need to. You'll feel like home as soon as you step out of it.", imageUrl: roblox , type: "Technology", instructorUrl: adeleye , tick: checked})
        ...
        server.create("van", { id: "13", students: 7, rating: 4.3,name: "Advanced UX Course", price: 70, description: "With this van, you can take your travel life to the next level. The Green Wonder is a sustainable vehicle that's perfect for people who are looking for a stylish, eco-friendly mode of transport that can go anywhere.", imageUrl: python, type: "Development", instructorUrl: adeleye , tick: checked})
