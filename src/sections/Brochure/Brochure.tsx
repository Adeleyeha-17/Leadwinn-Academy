...
export const Brochure = () => {
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between py-20 md:px-12 sm:py-28 px-5 xl:px-20  md:max-lg:max-w-6xl lg:max-xl:max-w-7xl font-poppins mx-auto">
