    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center lg:space-x-5 md:px-12 pt-28 sm:pb-10 lg:pb-20 xl:pb-0 px-5 xl:px-20 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto font-poppins">
        <div className="font-poppins text-heading lg:w-1/2">
          <h1
            className="max-lg:text-center max-sm:text-2xl sm:max-lg:text-3xl lg:max-xl:text-[2.3125rem] xl:max-2xl:text-[2.53125rem] font-bold mb-6 sm:mx-0">Limitless learning at your fingertips</h1>
          <h1 className="mb-6 max-sm:text-center text-base lg:text-sm xl:text-lg lg:max-w-[30rem] xl:max-w-[36rem]">Online learning and teaching marketplace with courses & over 100 students. Taught by experts to help you acquire new skills.</h1>

          <div className="flex text-xs sm:text-base gap-3 mb-7">
