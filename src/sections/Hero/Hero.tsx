...
export const Hero: React.FC<HomeProps> = () => {
  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row justify-between lg:space-x-20 md:px-12 pt-6 sm:pb-10 lg:max-xl:pb-20 xl:pt-10 px-5 xl:px-24 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
