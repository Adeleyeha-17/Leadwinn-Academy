  ...
  return (
    <div>
      <div className="bg-footer-blue flex flex-col justify-center items-center w-full h-full py-[6rem] xl:py-[8.1rem] text-white font-poppins relative">
        <img src={leftPlan} className="hidden lg:flex h-[18rem] xl:h-[23.5rem] absolute xl:top-8 left-0 bottom-0"/>
        <img src={rightPlan} className="hidden lg:flex h-[18rem] xl:h-[23.5rem] absolute xl:top-8 right-0 bottom-0"/>
