...
export const  MobilePlans = () => {
  ...
  <div className="bg-skill h-full font-poppins px-5 flex flex-col gap-10 items-center justify-center sm:hidden">
   ...
   <div className="bg-white mx-auto w-[20rem]  h-full rounded-2xl text-heading p-5 pb-10">
...
<div className="mb-5">
   ...
   <h4 className="text-sm lg:text-base font-semibold mb-3">Features</h4>
    ...
    <div className='mb-4 border-b border-skill-hov flex flex-col'>
      <div className="flex justify-between items-center" >
        <div className="flex gap-2 mb-2">
          <img src={experienceA} alt="Experience Icon" className="w-4"  loading="eager"/>
          <div className="flex gap-[2.3rem]">
          <div>

          <span className="text-xs">Personalized Learning Experience</span>
          </div>
          <img src={tips} className='w-4 cursor-pointer' onClick={() => toggleTab(0 + 1)} loading="eager"/>
          </div>
    ...
    <div className='mb-4 border-b border-skill-hov flex flex-col'>
      <div className="flex justify-between items-center">
          <div className="flex gap-2 mb-2">
          <img src={time} alt="Pricing Icon" className="w-4" loading="eager"/>
          <div className="flex gap-[9.35rem]">
          <span className="text-xs">Time Flexibility</span>
          <img src={tips} className='w-4 cursor-pointer' onClick={() => toggleTab(1 + 1)} loading="eager"/>
          </div>
          </div>
    ...
    <div className='mb-4 border-b border-skill-hov flex flex-col'>
      <div className="flex justify-between items-center" >
        <div className="flex gap-2 mb-2">
          <img src={review} alt="Pricing Icon" className="w-4 sm:w-5 lg:w-6"  loading="eager"/>
          <div className="flex gap-[9.32rem]">
          <span className="text-xs">Project Review</span>
          <img src={tips} className='w-4 cursor-pointer' onClick={() => toggleTab(2 + 1)} loading="eager"/>
          </div>
          </div>
      </div>
      <motion.div initial={{ opacity: 0, height: 0 }}
    ...
    <div className='mb-4 border-b border-skill-hov flex flex-col'>
      <div className="flex justify-between items-center" >
        <div className="flex gap-2 mb-2">
          <img src={replay} alt="Pricing Icon" className="w-4 sm:w-5 lg:w-6"  loading="eager"/>
          <div className="flex gap-[12.2rem]">
          <span className="text-xs">Replay</span>
          <img src={tips} className='w-4 cursor-pointer' onClick={() => toggleTab(3 + 1)} loading="eager"/>
          </div>
        </div>
      </div>
      <motion.div initial={{ opacity: 0, height: 0 }}
    ...
    <div className='mb-4 border-b border-skill-hov flex flex-col'>
      <div className="flex justify-between items-center" >
        <div className="flex gap-2 mb-2">
          <img src={pricing} alt="Experience Icon" className="w-4"  loading="eager"/>
          <div className="flex gap-[8.65rem]">
          <div>

          <span className="text-xs">Premium Pricing</span>
          </div>
          <img src={tips} className='w-4 cursor-pointer' onClick={() => toggleTab(9 + 1)} loading="eager"/>
          </div>
      ...
      <div className="mb-5">
         ...
         <h4 className="text-sm lg:text-base font-semibold mb-3">Features</h4>
          ...
          <div className='mb-4 border-b border-skill-hov flex flex-col'>
            <div className="flex justify-between items-center" >
              <div className="flex gap-2 mb-2">
                <img src={experienceB} alt="Experience Icon" className="w-4"  loading="eager"/>
