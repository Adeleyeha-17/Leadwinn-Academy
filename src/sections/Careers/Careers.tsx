...
export const Careers = () => {
  return (
   ...
   <div className="flex max-sm:flex-col justify-center items-center gap-10 sm:px-16">
     ...
     <div>
       <img src={careerTop} className="h-[15.5rem] w-[18.5rem] sm:h-[23rem] sm:w-[27rem]" loading="eager"/>
     </div>
   </div>
   <div className="flex max-sm:flex-col-reverse justify-center items-center gap-10 sm:px-16 mt-10 sm:mt-20">
   <div>
       <img src={careerBottom} className="h-[15.5rem] w-[18.5rem] sm:h-[23rem] sm:w-[27rem]" loading="eager"/>
     </div>
