  ...
  return (
    <div>
      <div className="bg-footer-blue flex flex-col justify-center items-center w-full h-full py-[7.87rem] text-white font-poppins relative">
        <img src={leftPlan} className="hidden sm:flex sm:h-[21rem] xl:h-[22rem] absolute top-0 left-0 bottom-0"/>
        <img src={rightPlan} className="hidden sm:flex sm:h-[21rem] xl:h-[22rem] absolute top-0 right-0 bottom-0"/>
