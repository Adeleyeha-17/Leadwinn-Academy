...
export const Knowledge = () => {
  return (
   ...
   <img src={leftPlan} className="hidden lg:flex lg:h-[19.5rem] xl:h-[22rem] absolute top-0 left-0 bottom-0"/>
   <img src={rightPlan} className="hidden lg:flex lg:h-[19.5rem] xl:h-[22rem] absolute top-0 right-0 bottom-0"/>
