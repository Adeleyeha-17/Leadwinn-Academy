  ...
  return (
    <div className="font-poppins pb-10 md:px-12 px-5 py-10 xl:px-40 md:py-20 lg:max-xl:max-w-6xl mx-auto">
      ...
      <div className="py-5 sm:py-20">
        <div className="bg-nav-blue sm:max-lg:h-[11rem] lg:h-[10.125rem] w-1/2 sm:w-full rounded-[3.125rem] font-poppin mx-auto max-sm:mt-16 max-sm:py-10 flex justify-center items-center">
          <div className="items-center justify-evenly sm:flex sm:mt-3 w-full px-10 xl:px-20">

            <div className="flex flex-col mb-10 sm:mb-0 items-center justify-cennter gap-5 sm:mt-5">
              <h1 className="text-head-blue text-4xl font-medium">100+</h1>
              <h4 className="w-[13rem] text-xs text-center">Trained students across 10 countries</h4>
            </div>
            ...
            <div className="flex flex-col mb-10 sm:mb-0 items-center justify-center gap-5">
              <h1 className="text-head-blue text-4xl font-medium">50+</h1>
              <h4 className="w-[10rem] text-xs text-center">projects submitted</h4>
            </div>
            ...
            <div className="flex justify-center flex-col mb-8 sm:mb-0 items-center gap-5">
              <h1 className="text-head-blue text-4xl font-medium">100+</h1>
              <h4 className="w-[10rem] text-xs text-center">certificates earned</h4>
            </div>

            <div className="w-16 lg:w-40 mb-8 sm:mb-0 border-white border transform rotate-90 mx-auto rounded-lg"></div>

            <div className="flex justify-center flex-col mb-8 sm:mb-0 items-center gap-5">
              <h1 className="text-head-blue text-4xl font-medium">99%</h1>
              <h4 className="w-[13rem] text-xs text-center">of graduates recorded</h4>
            </div>
          </div>
