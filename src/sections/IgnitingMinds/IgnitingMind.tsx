  ...
  return (
    <div className="font-poppins pb-10 md:px-12 px-5 py-10 xl:px-40 md:py-20 lg:max-xl:max-w-6xl mx-auto">
      ...
      <div className="py-5 sm:py-20">
        <div className="bg-gradient-to-br from-[#0965CE] to-[#01152C] sm:h-[10rem] w-1/2 sm:w-full rounded-[3.125rem] font-poppin mx-auto max-sm:mt-16 max-sm:py-10 flex justify-center items-center">
