  ...
  return (
    <div className="bg-nav-blue w-full h-full py-10 sm:py-16 lg:py-24 xl:py-32 flex items-center justify-center font-poppins relative mx-auto">
      ...
      <div className="flex flex-col gap-1 sm:gap-2 items-center justify-center text-center text-head-black">
        ...
        <Link to="/register" className="flex justify-center items-center py-1 sm:py-2 lg:py-3 px-6 lg:px-16 bg-head-blue text-white text-xs md:text-sm font-medium sm:font-semibold rounded-3xl transition hover:bg-blue-600 ease-in-out duration-300">Sign Up Now</Link>
