...
<div className="bg-nav-blue h-full font-poppins max-sm:px-5 py-20 sm:py-28 sm:px-10 flex max-sm:flex-col gap-10 justify-center sm:items-center">
         <div className="flex flex-col gap-3">
            ...
            <a download="" className={ `inline-block justify-center items-center py-2 px-4 md:px-6 bg-head-blue text-white text-xs font-semibold rounded-3xl transition hover:bg-blue-600 ease-in-out duration-300 cursor-pointer`}>Learn more</a>
