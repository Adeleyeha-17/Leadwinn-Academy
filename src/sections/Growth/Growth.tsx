...
export const Growth = () => {
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between py-10 md:px-12 md:py-20 px-5 xl:px-24 lg:py-20 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl font-poppins mx-auto">
      <div className="flex max-sm:flex-col md:justify-between md:items-center sm:w-full">
        <div className="flex flex-col gap-4 lg:gap-6 text-head-black md:w-2/5 max-sm:mb-10">
          ...
          <Link to="/about" className="flex justify-center items-center sm:max-md:w-28 sm:max-md:h-10 md:w-36 md:h-10 w-24 h-8 gap-3 bg-head-blue text-white font-poppins text-xs sm:font-semibold rounded-3xl transition hover:bg-blue-600 ease-in-out duration-300">LEARN MORE</Link>
