...
Knowledge
        ...
        <div className="mt-3">
        <Link to="/courses" className={`inline-block justify-center items-center py-2 lg:py-3 px-4 lg:px-6 bg-head-blue text-white text-xs font-semibold rounded-3xl transition hover:bg-blue-600 ease-in-out duration-300 cursor-pointer`}>Become An Instructor</Link>
