...
export const Faq: React.FC = () => {
   ...
   return (
      <div className="px-4 sm:px-20 lg:px-10 p-16 md:max-lg:max-w-6xl lg:max-w-7xl mx-auto">
...

         {
            ...
            <div key={index} className='mb-4 border-b border-gray-300 cursor-pointer py-2 flex flex-col'>
               <div className="flex justify-between items-center"
                  ...
                  <h3 className='text-head-black w-3/4 sm:w-full text-sm sm:px-0 sm:text-base xl:text-lg font-bold focus:border-none'>{
                     `${data.title}?`
                  }</h3>
               ...
               activeAccordion === index + 1 && (
                  <div className='pr-6 sm:pr-10'>
                     <p className='text-head-black text-xs sm:text-base'>{
                        data.content
                     }</p>
                  </div>
               )
