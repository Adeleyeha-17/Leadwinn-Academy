...
export const Testimonial = () => {
   ...
   <div className="flex flex-col md:flex-row justify-between ">
         ...
         <div className="grid sm:grid-cols-2 items-center mb-10">
            ...
            <div className='md:bg-white font-poppins md:bg-opacity-30 rounded-lg h-32 sm:h-40 lg:h-52 xl:h-72 max-sm:w-72 max-lg:px-5 flex items-center justify-center max-sm:mx-auto sm:-ml-12 md:-ml-10 xl:-ml-30'>
