...
export const Testimonial = () => {
   ...
   return (
      <div className="bg-gradient-to-tl from-test-gra-2 to-test-gra h-[270px] md:h-[320px] lg:h-[440px] xl:h-[550px] font-poppins md:flex flex-col md:justify-center max-sm:px-10 max-sm:py-8 md:p-36 text-white overflow-hidden ">
               ...
               <Slider {...sliderSettings} className='w-full lg:w-4/5'>
                  ...
                  testimonials.map((testimonial, index) => (
                     <div key={index}
                        ...
                        <p className="text-xs lg:text-sm xl:text-base max-sm:mb-3 sm:mb-2 lg:mb-4 flex items-center justify-center">
                           {
                           `"${
                              testimonial.message
                           }"`
                        }</p>
                        <h3 className="text-xs lg:text-sm xl:text-base sm:max-xl:pt-6 xl:pt-12 xl:mb-12 flex items-center justify-center">
                           {
                           testimonial.name
                        }</h3>
                     </div>
