      ...
      <div className="bg-gradient-to-tl from-test-gra-2 to-test-gra md:h-4/5 font-poppins text-white overflow-hidden relative">
         ...
         <div className="grid sm:grid-cols-2 items-center mb-10">
            <div className='max-sm:mb-5'>
               <img src="./sliderImg.svg" alt="slider Image" className="max-sm:w-4/5 max-sm:mx-auto"/>
            </div>

            <div className='md:bg-white font-poppins md:bg-opacity-30 rounded-lg h-32 sm:h-40 lg:h-52 xl:h-72 max-sm:w-72 max-lg:px-5 lg:p-20 flex items-center justify-center max-sm:mx-auto sm:-ml-12 md:-ml-10 xl:-ml-24 2xl:-ml-32'>
