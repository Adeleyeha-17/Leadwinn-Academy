...
export const Testimonial = () => {
  ...
  return (
    <div className="bg-gradient-to-tl from-test-gra-2 to-test-gra h-81 xl:h-80 font-poppins flex flex-col items-center justify-center p-36 overflow-hidden relative">
      ...
      <div className='bg-white text-white font-poppins bg-opacity-10 rounded-lg h-72 xl:h-96 w-full flex items-center justify-center lg:-ml-40 xl:-ml-48 pt-20 xl:pt-20'>
