...
export const DownloadBrochure = () => {
  return (
    <div className="bg-nav-blue w-full h-full py-10 sm:py-16 lg:py-24 flex items-center justify-center font-poppins relative mx-auto">
      <img src={brochureLeft} className="absolute top-0 left-1 sm:left-20 lg:left-16 xl:left-52 h-[3.5rem] w-[3.5rem] sm:h-[6rem] sm:w-[6rem] lg:h-[8rem] lg:w-[8rem] xl:h-[9rem] xl:w-[9rem]" alt={brochureLeft}/>
      <img src={brochureRight} className="absolute top-0 right-1 sm:right-20 lg:right-16 xl:right-52 h-[3.5rem] w-[3.5rem] sm:h-[6rem] sm:w-[6rem] lg:h-[8rem] lg:w-[8rem] xl:h-[9rem] xl:w-[9rem]" alt={brochureLeft}/>
      <img src={brochureButLeft} className="absolute bottom-0 left-0 h-[6rem] w-[6rem] sm:h-[9rem] sm:w-[12rem] lg:h-[12rem] xl:h-[12rem] lg:w-[15rem]" alt={brochureButLeft}/>
      <img src={brochureButRight} className="absolute bottom-0 right-0 h-[6rem] w-[6rem] sm:h-[9rem] sm:w-[12rem] lg:h-[12rem] xl:h-[12rem] lg:w-[15rem]" alt={brochureButLeft}/>
