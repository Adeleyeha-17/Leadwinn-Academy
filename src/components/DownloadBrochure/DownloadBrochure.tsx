...
export const DownloadBrochure = () => {
  return (
    <div className="bg-nav-blue w-full h-full py-10 sm:py-16 lg:py-24 flex items-center justify-center font-poppins relative mx-auto">
      <img src={brochureLeft} className="absolute top-0 left-1 sm:left-20 lg:left-16 xl:left-52 w-[3.5rem] sm:w-[6rem] lg:w-[8rem] xl:w-[9rem]" alt={brochureLeft}/>
      <img src={brochureRight} className="absolute top-0 right-1 sm:right-20 lg:right-16 xl:right-52 w-[3.5rem] sm:w-[6rem] lg:w-[8rem] xl:w-[9rem]" alt={brochureLeft}/>
      <img src={brochureButLeft} className="absolute bottom-0 left-0 w-[6rem] sm:w-[12rem] lg:w-[15rem]" alt={brochureButLeft}/>
      <img src={brochureButRight} className="absolute bottom-0 right-0 w-[6rem] sm:w-[12rem] lg:w-[15rem]" alt={brochureButLeft}/>
