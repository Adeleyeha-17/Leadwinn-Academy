      ...
      <div>
         <div className="flex justify-between items-center lg:max-xl:px-10 lg:space-x-20 xl:space-x-2 h-16 px-5 xl:px-20 pt-10 xl:pt-16 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
            <div className="flex justify-between items-center gap-2">
               ...
               <span className="flex flex-col text-lead-black text-base xl:text-lg font-normal font-poppins">
                  <h1>Leadwinn</h1>
                  <h1>Academy</h1>
               </span>
            </div>

            <div className='hidden sm:flex sm:max-md:space-x-3 md:max-xl:space-x-5 xl:space-x-9 font-poppins text-xs md:max-lg:text-sm lg:text-base xl:text-lg font-normal text-head-black'>
               {
               navLinks.map(link => (
                  <Link key={
                        link.path
