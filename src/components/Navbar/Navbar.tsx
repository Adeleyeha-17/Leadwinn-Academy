...
export const Navbar: React.FC = () => {
   ...
   return (
      <div className="bg-nav-blue">
         <div className="flex justify-between items-center lg:space-x-20 xl:space-x-20 px-5 pt-10 xl:pt-16 sm:px-10 lg:px-0 xl:px-36 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
