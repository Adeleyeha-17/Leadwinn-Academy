...
export const Navbar: React.FC = () => {
   ...
   return (
      <div>
         <div className="flex justify-between items-center lg:space-x-20 xl:space-x-2 h-16 px-5 md:px-0 xl:px-36 pt-10 xl:pt-16 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
