...
export const Navbar: React.FC = () => {
  ...
  <div
    className={nav ? 'fixed left-0 bottom-0 top-0 w-full h-full pt-4 bg-nav-blue border-r border-gray-200 md:hidden transition-all ease-in-out duration-500 z-20' : 'fixed -top-full top-0 bottom-0 h-full w-full transition-all ease-in-out duration-700 z-20'}
  >
