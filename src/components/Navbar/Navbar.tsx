...
export const Navbar: React.FC = () => {
   ...
   return (
      <div className="bg-nav-blue">
         <div className="flex justify-between items-center lg:space-x-20 xl:space-x-20 px-5 pt-7 sm:px-20 lg:px-0 xl:px-28 lg:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
