...
export const Learning = () => {
  return (
    <div className="bg-learning-mobile sm:bg-learning bg-contain bg-no-repeat flex items-center justify-center h-[16.25rem] lg:h-[20rem] xl:h-[32rem] 2xl:h-[45rem] max-sm:-mb-32 sm:-mb-20 lg:-mb-10 font-poppins">
