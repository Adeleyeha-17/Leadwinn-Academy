      ...
      <div>
        ...
        <div className={toggle === 1 ? "block" : "hidden"}>
          <div className='text-heading py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[21.1rem] sm:w-[39.75rem] h-[16rem] sm:h-[30rem] text-xs xl:text-base'>Ideal for beginners (ages 6+), our Basic MIT App Inventor course introduces mobile app interface design fundamentals. Explore MIT App Inventor basics, unlocking creativity for simple and interactive app design.</p>
            <img
          src={mitBasic}
          alt="MIT Basic"
        ...
        />
          ...
          <div className='bg-nav-blue text-heading py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[21.1rem] sm:w-[39.75rem] h-[16rem] sm:h-[30rem] text-xs xl:text-base'>Elevate your mobile app design skills with our Intermediate course (ages 7+). Engage in projects, collaborative design, and create feature-rich mobile applications.</p>
            <img
          src={mitIntermediate}
        ...
        />
          ...
          <div className='bg-head-black text-white py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[21.1rem] sm:w-[39.75rem] h-[16rem] sm:h-[30rem] text-xs xl:text-base'>Become a mobile app design expert with our Advanced MIT App Inventor course (ages 8+). Delve into advanced concepts, algorithmic design, and project development. Unleash your creativity, mastering innovative mobile app interfaces.</p>
            <img
          src={mitAdvanced}
          alt="MIT Advanced"
          className="w-[21.1rem] h-max mx-10 mt-10 rounded-3xl border-4 border-blue-900 overflow-hidden"
        ...
        <div className={toggle === 2 ? "block" : "hidden"}>
          <div className='text-heading py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[21.1rem] sm:w-[39.75rem] h-[16rem] sm:h-[30rem] text-xs xl:text-base'>Ideal for beginners (ages 8+), our Basic 3D Roblox Design course covers immersive 3D experiences in the Roblox universe. Learn basics of 3D game design, character modeling, and world building.</p>
             <img
          src={robloxBasic}
          alt="Roblox Basic"
          className="w-[21.1rem] h-max mx-10 mt-10 rounded-3xl border-4 border-blue-900 overflow-hidden"
        />
          ...
          <div className='bg-nav-blue text-heading py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[21.1rem] sm:w-[39.75rem] h-[16rem] sm:h-[30rem] text-xs xl:text-base'>Enhance your 3D Roblox design skills with our Intermediate course (ages 9+). Explore projects, collaborate on 3D designs, and master advanced features for creating engaging game environments.</p>
             <img
        ...
        />
          ...
          <div className='bg-head-black text-white py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[21.1rem] sm:w-[39.75rem] h-[16rem] sm:h-[30rem] text-xs xl:text-base'>Master 3D Roblox design with our Advanced course (ages 10+). Explore advanced 3D concepts, immersive scripting, and project development, unleashing creativity for stunning environments in the Roblox universe.</p>
             <img
          src={robloxAdvanced}
          alt="Roblox Advanced"
          className="w-[21.1rem] h-max mx-10 mt-10 rounded-3xl border-4 border-blue-900 overflow-hidden"
