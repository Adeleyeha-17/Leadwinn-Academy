      ...
      <div>
        ...
        <div className={toggle === 0 ? "block" : "hidden"}>
          <div className='text-heading  flex gap-3 py-10 sm:py-20 flex-col items-center justify-center'>
            ...
            <p className='w-[23rem] sm:w-[46rem] xl:w-[58rem] text-[0.5rem] xl:text-base'>Delve into coding basics with Basic Scratch, tailored for beginners aged 6 and up. It instills block-based programming skills, fostering logical thinking and problem-solving.</p>
          ...
          <div className='bg-nav-blue text-heading flex py-10 sm:py-20 gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[23rem] sm:w-[46rem] xl:w-[58rem] text-[0.5rem] xl:text-base'>Level up your coding skills with Intermediate Scratch, tailored for ages 7 and above. Dive deeper into project-based learning, collaborative coding, and advanced challenges to enhance creativity and problem-solving.</p>
          ...
          <div className='bg-head-black text-white py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[23rem] sm:w-[46rem] xl:w-[58rem] text-[0.5rem] xl:text-base'>Master advanced Scratch coding for ages 8+. Go beyond basics, explore advanced concepts, algorithmic design, and project development. Unleash your coding potential.</p>
        ...
        <div className={toggle === 1 ? "block" : "hidden"}>
          <div className='text-heading py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[22rem] sm:w-[46rem] xl:w-[58rem] text-[0.5rem] xl:text-base'>Ideal for beginners (ages 6+), our Basic MIT App Inventor course introduces mobile app interface design fundamentals. Explore MIT App Inventor basics, unlocking creativity for simple and interactive app design.</p>
          ...
          <div className='bg-nav-blue text-heading py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[22rem] sm:w-[46rem] xl:w-[58rem]  text-[0.5rem] xl:text-base'>Elevate your mobile app design skills with our Intermediate course (ages 7+). Engage in projects, collaborative design, and create feature-rich mobile applications.</p>
            <video src="" autoPlay loop muted playsInline preload="auto" className='w-[21.1rem] sm:w-[39.75rem] h-[16rem] sm:h-[30rem] mt-10 rounded-3xl border-4 border-blue-900'></video>
          </div> 
          ...
          <div className='bg-head-black text-white py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[22rem] sm:w-[46rem] xl:w-[58rem]  text-[0.5rem] xl:text-base'>Become a mobile app design expert with our Advanced MIT App Inventor course (ages 8+). Delve into advanced concepts, algorithmic design, and project development. Unleash your creativity, mastering innovative mobile app interfaces.</p>
            <video src="" autoPlay loop muted playsInline preload="auto" className='w-[21.1rem] sm:w-[39.75rem] h-[16rem] sm:h-[30rem] mt-10 rounded-3xl border-4 border-blue-900'></video>
          </div>
        </div>
        ...
        <div className={toggle === 2 ? "block" : "hidden"}>
          <div className='text-heading py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[22rem] sm:w-[46rem] xl:w-[58rem]  text-[0.5rem] xl:text-base'>Ideal for beginners (ages 8+), our Basic 3D Roblox Design course covers immersive 3D experiences in the Roblox universe. Learn basics of 3D game design, character modeling, and world building.</p>
            <video src="" autoPlay loop muted playsInline preload="auto" className='w-[21.1rem] sm:w-[39.75rem] h-[16rem] sm:h-[30rem] mt-10 rounded-3xl border-4 border-blue-900'></video>
          </div>
          ...
          <div className='bg-nav-blue text-heading py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[22rem] sm:w-[46rem] xl:w-[58rem]  text-[0.5rem] xl:text-base'>Enhance your 3D Roblox design skills with our Intermediate course (ages 9+). Explore projects, collaborate on 3D designs, and master advanced features for creating engaging game environments.</p>
            <video src="" autoPlay loop muted playsInline preload="auto" className='w-[21.1rem] sm:w-[39.75rem] h-[16rem] sm:h-[30rem] mt-10 rounded-3xl border-4 border-blue-900'></video>
          </div>
          ...
          <div className='bg-head-black text-white py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[22rem] sm:w-[46rem] xl:w-[58rem]  text-[0.5rem] xl:text-base'>Master 3D Roblox design with our Advanced course (ages 10+). Explore advanced 3D concepts, immersive scripting, and project development, unleashing creativity for stunning environments in the Roblox universe.</p>
            <video src="" autoPlay loop muted playsInline preload="auto" className='w-[21.1rem] sm:w-[39.75rem] h-[16rem] sm:h-[30rem] mt-10 rounded-3xl border-4 border-blue-900'></video>
          </div>
        </div>
        ...
        <div className={toggle === 3 ? "block" : "hidden"}>
          <div className='text-heading py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[22rem] sm:w-[46rem] xl:w-[58rem]  text-[0.5rem] xl:text-base'>Perfect for beginners aged 9+, our Basic UI/UX Design course covers fundamental principles. Learn to create visually appealing, user-friendly designs, building the foundation for intuitive digital experiences.</p>
            <video src="" autoPlay loop muted playsInline preload="auto" className='w-[21.1rem] sm:w-[39.75rem] h-[16rem] sm:h-[30rem] mt-10 rounded-3xl border-4 border-blue-900'></video>
          </div>
          ...
          <div className='bg-nav-blue text-heading py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[22rem] sm:w-[46rem] xl:w-[58rem]  text-[0.5rem] xl:text-base'>Enhance UI/UX skills with our Intermediate course for learners aged 10+. Engage in project-based learning, collaborative design, and explore advanced techniques for improved user interactions and design aesthetics.</p>
            <video src="" autoPlay loop muted playsInline preload="auto" className='w-[21.1rem] sm:w-[39.75rem] h-[16rem] sm:h-[30rem] mt-10 rounded-3xl border-4 border-blue-900'></video>
          </div>
          ...
          <div className='bg-head-black text-white py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[22rem] sm:w-[46rem] xl:w-[58rem]  text-[0.5rem] xl:text-base'>
        ...
        <div className={toggle === 4 ? "block" : "hidden"}>
          <div className='text-heading h-[30rem] sm:h-[50rem] flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[22rem] sm:w-[46rem] xl:w-[58rem]  text-[0.5rem] xl:text-base'>Tailored for beginners aged 9+, the Basic Front-End Web Development course introduces the fundamentals of building a visually appealing website. Dive into HTML for structure, CSS for styling, and basic JavaScript for interactivity.</p>
          ...
          <div className='bg-head-black text-white h-[30rem] sm:h-[50rem] flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[22rem] sm:w-[46rem] xl:w-[57rem]  text-[0.5rem] xl:text-base'>Master front-end web development with our Advanced course for learners aged 11+. Dive into advanced HTML, CSS, and JavaScript concepts, creating interactive web applications with a focus on front-end development.</p>
        ...
        <div className={toggle === 5 ? "block" : "hidden"}>
          <div className='text-heading py-10 sm:py-20 flex gap-3 flex-col items-center justify-center'>
            ...
            <p className='w-[22rem] sm:w-[46rem] xl:w-[58rem]  text-[0.5rem] xl:text-base'>For beginners aged 10+, our Basic Python Programming course introduces Python fundamentals, covering syntax, data structures, and problem-solving. Build a strong foundation in Python.</p>
