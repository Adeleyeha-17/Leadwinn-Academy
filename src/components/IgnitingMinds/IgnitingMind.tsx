...
export const IgnitingMind = () => {
  return (
    <div className="py-5 md:px-12 px-5 xl:px-40 lg:py-10 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl font-poppins">
        ...
        <div className="text-head-black sm:w-[27.8125rem]">
          <h1 className="text-xl lg:text-[2.1rem] xl:text-[2.375rem] lg:leading-[2.5rem] xl:leading-[3rem] font-bold mb-5 sm:mb-10 max-lg:w-[14rem]">Empowering the  <span className="text-hero-blue">Future of Technology</span></h1>
