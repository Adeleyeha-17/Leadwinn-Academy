...
export const Hero: React.FC<HomeProps> = () => {
  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row justify-between lg:space-x-20 py-10 sm:px-20 md:py-20 px-5 lg:px-0 xl:px-36 lg:py-20 md:max-lg:max-w-6xl lg:max-w-7xl mx-auto">
        <div className="font-poppins text-lead-black md:w-3/5 mx-auto">
          <h1 className="max-sm:text-[25px] sm:max-md:text-[30px] md:text-[40px] 2xl:text-[50px] font-bold mb-6 leading-normal max-w-md mx-auto sm:mx-0 md:max-w-3xl">Engage in the Future of Learning with <span className={`animate-slide-top ${currentColorClass}`}>{currentWord}</span>  Online Coding Classes</h1>
    ...
    <div className="md:w-2/5">
      ...
      <div className=" bg-gradient-to-tr from-home-gra-2 to-home-gra h-2/4 sm:h-2/5 md:h-52 w-6/12 sm:w-3/4 rounded-3xl font-poppins text-white font-semibold max-md:text-sm md:text-xs  xl:text-lg mt-2 sm:mt-34 mx-auto mb-28 sm:max-md:px-10 md:max-xl:px-6 py-3 md:max-xl:py-9 xl:py-3 sm:mb-36">
