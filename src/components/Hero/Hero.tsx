    ...
    <div>
      <div className="flex flex-col md:flex-row mt-14 md:mt-0 justify-between lg:space-x-20 py-20 px-5 lg:px-0 lg:py-20 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
        <div className="font-poppins text-lead-black">
          ...
          <h1 className="xl:w-[570px] md:max-lg:w-[400px] lg:w-[520px] mb-6 md:mb-5 lg:pr-20 text-sm md:text-base xl:text-lg">Elevate Learning with Online Coding Classes Empowering Kids and Teens Aged 6-17 to Shape the Future through Design and Innovation.</h1>
