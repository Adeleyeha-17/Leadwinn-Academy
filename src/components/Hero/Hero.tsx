...
export const Hero: React.FC<HomeProps> = () => {
  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between lg:space-x-20 py-10 sm:max-md:px-20 md:py-20 px-5 lg:px-0 xl:px-36 lg:py-20 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
        <div className="font-poppins text-lead-black md:w-3/5 mx-auto">
          <h1 className="text-3xl md:text-head lg:font-bold sm:font-semibold mb-6 leading-normal max-w-md mx-auto sm:mx-0 md:max-w-3xl">Engage in the Future of Learning with <span className={`animate-slide-top ${currentColorClass}`}>{currentWord}</span>  Online Coding Classes</h1>
    ...
    <div className="md:w-2/5">
      ...
      <div className=" bg-gradient-to-tr from-home-gra-2 to-home-gra h-5/6 md:h-64 w-1/2 sm:w-3/4 rounded-3xl font-poppins text-white font-semibold text-sm lg:text-lg items-center justify-between mt-14 mx-auto sm:flex mb-28 py-3 md:py-10 sm:py-0 sm:mb-36">
