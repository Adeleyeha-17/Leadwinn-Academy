    ...
    <div>
      <div className="flex flex-col md:flex-row justify-between lg:space-x-20 sm:px-12 md:py-16 px-5 xl:px-20 lg:py-20 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
        <div className="font-poppins text-head-black md:w-3/5 mx-auto">
          <h1 className="max-sm:text-[25px] sm:max-lg:text-[30px] lg:max-2xl:text-[40.5px] 2xl:text-[50px] font-bold mb-6 leading-normal max-w-md mx-auto sm:mx-0 md:max-w-[540px] lg:max-w-[560px]">Engage in the Future of Learning with <span className={`${currentColorClass}`}>
  {currentWord}
