    ...
    <div>
      <div className="flex flex-col md:flex-row justify-between lg:space-x-20 md:px-12 md:py-6 px-5 xl:px-28 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl">
        <div className="font-poppins text-head-black md:w-3/5">
          <h1 className="max-sm:text-[25px] sm:max-lg:text-[30px] lg:max-xl:text-[37px] xl:max-2xl:text-[40.5px] 2xl:text-[50px] font-bold mb-6 leading-normal max-w-md sm:mx-0 sm:max-w-[400px] lg:max-2xl:max-w-[545px] 2xl:max-w-[700px]">Engage in the Future of Learning with <span className={`${currentColorClass}`}>
  {currentWord}
    ...
    <div className="md:w-2/5">
      ...
      <div className=" bg-gradient-to-tr from-home-gra-2 to-home-gra h-2/5 sm:max-lg:h-[160px] sm:max-lg:w-[650px] lg:h-[184] w-1/2 lg:w-[811px] rounded-[50px] font-poppins text-white font-semibold text-sm sm:text-[14px] lg:text-xl mx-auto max-sm:mt-16 py-3 sm:px-6 xl:mt-32">
