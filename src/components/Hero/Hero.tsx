...
export const Hero: React.FC<HomeProps> = () => {
  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row justify-between lg:space-x-20 py-10 md:py-20 px-5 lg:px-0 xl:px-46 lg:py-20 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
