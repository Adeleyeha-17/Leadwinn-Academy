...
export const Hero: React.FC<HomeProps> = () => {
  ...
  return (
    ...
    <div className="md:w-2/5">
      ...
      <div className=" bg-gradient-to-tr from-home-gra-2 to-home-gra h-2/4 sm:h-2/5 md:h-52 w-6/12 sm:w-3/4 rounded-[50px] font-poppins text-white font-semibold max-md:text-sm md:text-xs xl:text-base mt-2 sm:mt-34 mx-auto mb-28 sm:max-md:px-10 md:px-6 py-3 md:py-9 sm:mb-36">
