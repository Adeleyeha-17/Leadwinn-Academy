...
export const Hero: React.FC<HomeProps> = () => {
  ...
  return (
    ...
    <div className="md:w-2/5">
      ...
      <div className=" bg-gradient-to-tr from-home-gra-2 to-home-gra h-2/4 sm:h-2/5 md:h-52 w-6/12 sm:w-3/4 rounded-3xl font-poppins text-white font-semibold text-sm xl:text-lg mt-2 sm:mt-34 mx-auto mb-28 sm:max-md:px-10 md:max-xl:px-6 py-3 md:max-xl:py-9 xl:py-3 sm:mb-36">
