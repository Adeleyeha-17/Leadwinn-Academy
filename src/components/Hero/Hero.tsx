...
export const Hero: React.FC<HomeProps> = () => {
  ...
  return (
    <div className="xl:px-20">
      <div className="flex flex-col md:flex-row mt-14 md:mt-0 justify-between lg:max-xl:px-10 lg:space-x-20 py-20 px-5 lg:px-0 lg:py-20 lg:p-20 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
        <div className="font-poppins text-lead-black">
          ...
          <h1 className="xl:w-[570px] md:max-lg:w-[400px] mb-6 md:mb-5 lg:pr-20 text-sm md:max-lg:text-base lg:text-base xl:text-xl">Elevate Learning with Online Coding Classes Empowering Kids and Teens Aged 6-17 to Shape the Future through Design and Innovation.</h1>

          <Button path="" title="Discover Course" />

        </div>

        <img src="./homeIllustration.svg" alt="home illustration" className="mx-auto sm:w-3/4 md:w-2/5 xl:w-auto"/>
      </div>

      <div className=" bg-gradient-to-tr from-home-gra-2 to-home-gra h-20 md:h-48 xl:h-72 w-4/5 xl:w-4/6 rounded-3xl font-poppins text-white md:font-bold text-xs md:text-sm lg:text-base xl:text-xl items-center justify-between px-10 -mt-10 xl:mt-16 mx-auto hidden md:flex md:mb-10">
