...
export const Hero: React.FC<HomeProps> = () => {
  ...
  return (
    ...
    <div className="w-2/5">
      ...
      <div className=" bg-gradient-to-tr from-home-gra-2 to-home-gra h-5/6 md:h-52 w-1/2 sm:w-2/3 rounded-3xl font-poppins text-white md:font-semibold text-xs md:text-sm lg:text-lg items-center justify-between mt-14 sm:mt-3 md:-mt-8 lg:-mt-7 xl:mt-6 mx-auto sm:flex mb-28 sm:mb-36">
