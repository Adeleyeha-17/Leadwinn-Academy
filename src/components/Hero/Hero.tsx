    ...
    <div>
      <div className="flex flex-col md:flex-row mt-14 md:mt-0 justify-between lg:max-xl:px-10 lg:space-x-20 sm:p-20 px-5 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
        <div className="font-poppins text-lead-black">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-myXL xl:text-7xl font-semibold md:max-xl:leading-snug xl:leading-heading mb-2 md:mb-5">Engage in the Future of Learning with <span className={`animate-slide-top ${currentColorClass}`}>{currentWord}</span>  Online Coding Classes</h1>
          <h1 className="mb-3 md:mb-5 lg:pr-20 text-sm md:max-lg:text-base lg:text-base xl:text-2xl">Elevate Learning with Online Coding Classes Empowering Kids and Teens Aged 6-17 to Shape the Future through Design and Innovation.</h1>
      ...
      <div className=" bg-gradient-to-tr from-home-gra-2 to-home-gra h-20 md:h-48 xl:h-72 w-4/5 xl:w-3/4 rounded-3xl font-poppins text-white md:font-bold text-xs md:text-sm lg:text-base xl:text-2xl items-center justify-between px-10 -mt-10 xl:mt-16 mx-auto hidden md:flex">
