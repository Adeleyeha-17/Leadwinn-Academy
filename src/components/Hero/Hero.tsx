...
export const Hero: React.FC<HomeProps> = () => {
  ...
  return (
    ...
    <div className="w-full">
      ...
      <div className=" bg-gradient-to-tr from-home-gra-2 to-home-gra h-5/6 sm:h-8 w-1.5 sm:w-3/5 rounded-3xl font-poppins text-white md:font-bold text-xs md:text-sm items-center justify-between p-32 sm:px-10 mt-14 sm:mt-3 md:-mt-8 lg:-mt-7 xl:mt-6 mx-auto sm:flex mb-28 sm:mb-36">
