...
export const Hero: React.FC<HomeProps> = () => {
  ...
  return (
    ...
    <div className="md:w-2/5">
      ...
      <div className=" bg-gradient-to-tr from-home-gra-2 to-home-gra h-5/6 sm:h-3/5 md:h-64 w-1/2 sm:w-4/5 md:w-3/4 rounded-3xl font-poppins text-white font-semibold text-sm lg:text-lg items-center justify-between mt-14 mx-auto sm:flex mb-28 py-3 sm:max-md:px-10 md:py-10 sm:py-0 sm:mb-36">
