...
export const Hero: React.FC<HomeProps> = () => {
  ...
  return (
    ...
    <div className="w-full">
      ...
      <div className=" bg-gradient-to-tr from-home-gra-2 to-home-gra h-20 md:h-56 lg:h-72 w-4/5 xl:w-4/6 rounded-3xl font-poppins text-white md:font-bold text-xs md:text-sm lg:text-base xl:text-xl items-center justify-between px-10 mt-3 md:-mt-8 lg:-mt-7 xl:mt-6 mx-auto hidden md:flex md:mb-36">
