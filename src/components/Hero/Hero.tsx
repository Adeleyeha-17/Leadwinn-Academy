...
export const Hero: React.FC<HomeProps> = () => {
  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between lg:space-x-20 py-10 sm:max-md:px-20 md:py-20 px-5 lg:px-0 xl:px-36 lg:py-20 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
        <div className="font-poppins text-lead-black w-3/5">
          ...
          <h1 className=" mb-6 text-sm md:text-base lg:text-lg md:max-w-xl">Elevate Learning with Online Coding Classes Empowering Kids and Teens Aged 6-17 to Shape the Future through Design and Innovation.</h1>
    ...
    <div className="w-2/5">
      ...
      <div className=" bg-gradient-to-tr from-home-gra-2 to-home-gra h-5/6 md:h-52 w-1/2 sm:w-2/3 rounded-3xl font-poppins text-white md:font-bold text-xs md:text-sm items-center justify-between mt-14 sm:mt-3 md:-mt-8 lg:-mt-7 xl:mt-6 mx-auto sm:flex mb-28 sm:mb-36">
