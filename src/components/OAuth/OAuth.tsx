...
<button
      ...
      className="flex items-center w-[20rem] sm:w-[23rem] lg:w-[20rem] xl:w-[28rem] text-head-black px-2 xl:px-4 py-2 xl:py-3 text-sm sm:text-base xl:text-xl font-bold rounded-2xl border border-head-black"
    >
