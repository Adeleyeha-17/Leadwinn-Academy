...
export const Goal = () => {
  ...
  return (
    <div className="flex flex-col justify-between py-10 md:px-12 md:py-20 px-5 xl:px-52 lg:py-20 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto font-poppins md:my-4">
