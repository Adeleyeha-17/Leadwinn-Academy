...
export const Goal = () => {
  ...
  return (
    <div className="flex flex-col justify-between py-10 md:px-12 md:py-20 px-5 xl:px-28 lg:py-20 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto font-poppins overflow-hidden">
   ...
   {goalData.map((data, index) => (
      <div key={index} className="w-full sm:w-[300px] md:w-[340px] mx-auto sm:mx-0 lg:w-[350px] h-[94px] rounded-xl shadow-lg shadow-outline bg-white flex items-center relative">
