         ...
         <div className='border-t-2 sm:border-t border-gray-400 mt-20'>
            ...
            <div className='flex flex-col max-sm:items-center lg:flex-row gap-4 mt-10 text-center'>
               <div className='flex gap-4'>
                  ...
                  <h5 className='text-[0.59375rem] md:text-sm flex items-center justify-center text-center'>Copyright © 2020 - 2023 Leadwinn Academy. All rights reserved
                  </h5>
               <div className='flex items-center gap-3 sm:gap-4 text-[0.59375rem] md:text-sm'>
