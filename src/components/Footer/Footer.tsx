...
export const Footer: React.FC = () => {
   ...
   return (
      <div className="bg-footer-blue text-white font-poppins pb-20 sm:px-12 sm:max-lg:gap-8 px-5 py-10 xl:px-28 md:py-20 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
