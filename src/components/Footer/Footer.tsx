      ...
      <div className="grid grid-flow-row sm:max-lg:grid-cols-2 lg:grid-flow-col gap-6 sm:max-md:gap-0 lg:gap-0 py-16 sm:max-lg:px-2 px-6 md:py-24 md:max-xl:px-18 xl:px-28 lg:max-xl:px-10 lg:space-x-20 md:max-w-6xl lg:max-w-7xl mx-auto sm:max-lg:ml-9">
         ...
         <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-4">
               ...
               <div className="flex flex-col gap-1">
                  ...
                  <h1 className="text-xs sm:text-sm lg:text-base">info@leadwinnacademy@gmail.com</h1>
               </div>
            </div>
         ...
         <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-4">
               ...
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" fill="none">
                  <circle cx="16" cy="16" r="15.3846" fill="white" stroke="white" stroke-width="1.23077"/>
                  <path d="M17.6623 3.38452H20.6818L14.0849 10.6841L21.8461 20.6153H15.7694L11.0104 14.5913L5.56386 20.6153H2.54273L9.59914 12.8073L2.15381 3.38532H8.38478L12.6867 8.89141L17.6623 3.38452ZM16.603 18.8662H18.2761L7.47566 5.04223H5.68037L16.603 18.8662Z" fill="#003B80" className="flex justify-center items-center ml-32"/>
               </svg>
