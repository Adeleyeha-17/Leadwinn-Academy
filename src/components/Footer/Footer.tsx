...
export const Footer: React.FC = () => {
   ...
   return (
      <div className="bg-footer-blue text-white font-poppins pb-20 sm:max-lg:gap-8 px-5 py-10 xl:px-28 md:py-20 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
         ...
         <div className='border-t-2 sm:border-t border-gray-400 mt-1 md:mt-2 lg:mt-20'>

            <div className='flex flex-col lg:flex-row items-center gap-4 mt-10 text-center'>
