...
export const Footer: React.FC = () => {
   ...
   return (
      ...
      <div className=" text-white font-poppins pb-10 md:px-12 px-5 py-10 xl:px-24 md:py-20 lg:max-xl:max-w-6xl mx-auto relative">
         ...
         <a href="https://api.whatsapp.com/send?phone=+2348165906106&text=Hello Leadwinn," className="text-[0.75rem] inline-block items-center justify-center gap-x-1 text-hero-blue z-20" target="_blank" rel="noopener noreferrer">
