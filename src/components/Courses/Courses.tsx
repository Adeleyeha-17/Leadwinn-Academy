      ...
      <div className="grid grid-cols-3 gap-x-28 gap-y-10">
         {courses.map((data, index) => (
            <div key={index} className="w-[26rem] relative rounded-xl overflow-hidden">
               ...
               <div className="absolute translate-y-56 hover:translate-y-0 transition ease-in-out duration-650 flex flex-col justify-center items-center gap-10 bg-courses bg-opacity-70 backdrop-blur-sm inset-0 text-white rounded-xl rounded-t-none">
