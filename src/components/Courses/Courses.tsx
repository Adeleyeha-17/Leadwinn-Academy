...
export const Courses = () => {
  ...
  return (
     <div className="bg-footer-blue h-[27rem] sm:h-[65rem] lg:h-[50rem] xl:h-[55rem]  font-poppins py-10 md:px-12 md:py-20 px-5 xl:px-40 lg:py-20 md:max-lg:max-w-6xl lg:max-xl:max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-6 sm:grid-cols-2 lg:grid-cols-3 sm:gap-10">
         {courses.map((data, index) => (
            <div key={index} className="w-[10rem] sm:w-[17rem] xl:w-[21rem] relative rounded-xl overflow-hidden mx-auto">
               <img src={data.img} alt={data.heading} className="w-full rounded-xl" />
               <div className="absolute translate-y-20 xl:translate-y-48 hover:translate-y-0 transition ease-in-out duration-680 flex flex-col justify-center items-center gap-10 bg-courses bg-opacity-70 backdrop-blur-sm inset-0 text-white rounded-3xl rounded-t-none">
