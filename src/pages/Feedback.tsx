         ...
         <div className="mx-auto">
            ...
            <form className="w-[360px]">
               ...
               <div className="relative mb-8 h-16">
                  ...
                  <input type="email" name="email" className="relative top-0 left-0 w-full h-full bg-none outline-none rounded-[0.75rem] p-[1.5rem] border-2 border-opacity-30 -z-10 " placeholder="Insert your email"/>
               </div>
