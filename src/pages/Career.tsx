  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: 1.2 }} >
      <div className="bg-footer-blue flex flex-col justify-center items-center w-full h-full py-[6rem] xl:py-[8.75rem] text-white font-poppins relative overflow-hidden">
        <img src={leftPlan} className="hidden lg:flex lg:h-[18rem] xl:h-[23.1rem] absolute xl:top-8 left-0 bottom-0" />
        <img src={rightPlan} className="hidden lg:flex lg:h-[18rem] xl:h-[23.1rem] absolute xl:top-8 right-0 bottom-0" />
